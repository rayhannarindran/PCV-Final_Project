...
def game(kartu):
    ...
    if len(permainan.dealer) >= 2:
        if permainan.point_dealer == 21:
            permainan.dealer_state = "Blackjack"
        elif permainan.point_dealer > 21:
            permainan.dealer_state = "Bust"
        else:
            permainan.dealer_state = "Safe"

        if permainan.point_player == 21:
            permainan.player_state = "Blackjack"
        elif permainan.point_player > 21:
            permainan.player_state = "Bust"
        else:
            permainan.player_state = "Safe"

        if permainan.point_computer == 21:
            permainan.computer_state = "Blackjack"
        elif permainan.point_computer > 21:
            permainan.computer_state = "Bust"
        else:
        ...
        if permainan.player_state == "Blackjack" and permainan.computer_state == "Blackjack":
        ...
        elif permainan.player_state == "Blackjack" and permainan.computer_state != "Blackjack":
            permainan.player_state = "Win"
            permainan.computer_state = "Lose"
        elif permainan.player_state != "Blackjack" and permainan.computer_state == "Blackjack":
            permainan.player_state = "Lose"
            permainan.computer_state = "Win"
        elif permainan.player_state == "Bust" and permainan.computer_state == "Bust":
            permainan.player_state = "Lose"
            permainan.computer_state = "Lose"
        elif permainan.player_state == "Bust" and permainan.computer_state != "Bust":
            permainan.player_state = "Lose"
            ...
            permainan.player_state = "Win"
            permainan.computer_state = "Lose"
        elif permainan.player_state == "Safe" and permainan.computer_state == "Safe":
            if permainan.point_player > permainan.point_computer:
                permainan.player_state = "Win"
                permainan.computer_state = "Lose"
            elif permainan.point_player < permainan.point_computer:
                permainan.player_state = "Lose"
                permainan.computer_state = "Win"
            else:
                permainan.player_state = "Draw"
